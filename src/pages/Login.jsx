...
export default function Login() {
    return <div>
        <form className="flex flex-col justify-center items-center gap-4 mt-32">
            ...
            <button className="font-light bg-terceira p-3 text-lg text-white shadow-md rounded-md w-11/12 mt-2 border-2 hover:border-black hover:solid hover:bg-transparent hover:text-black transition">Entrar</button>
            <div className="w-11/12 font-light -mt-3">
